<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="可退收(不含税)" align="center" prop="refundRequired"/>
...
const getList = async () => {
  loading.value = true
  try {
    const data = await TongFuProjectQueryApi.refundRequired(queryParams)
...
const handleExport = async () => {
  try {
    ...
    const data = await TongFuProjectQueryApi.refundRequiredExport(queryParams)
    download.excel(data, '需退收.xls')
  } catch {
  } finally {
