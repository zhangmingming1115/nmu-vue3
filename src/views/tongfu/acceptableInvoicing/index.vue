<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="可收票" align="center" prop="acceptableInvoicing"/>
...
const getList = async () => {
  loading.value = true
  try {
    const data = await TongFuProjectQueryApi.acceptableInvoicing(queryParams)
...
const handleExport = async () => {
  try {
    ...
    const data = await TongFuProjectQueryApi.acceptableInvoicingExport(queryParams)
    download.excel(data, '可收票.xls')
  } catch {
  } finally {
