...
// 工程交付 VO
export interface ProjectDeliveryVO {
  id: number // 主键ID
...
export const ProjectDeliveryApi = {
  ...
  // 查询工程投资管理分页
  getProjectDeliveryPage: async (params: any) => {
    return await request.get({ url: `/engineering/projectDelivery/page`, params })
  },

  // 查询工程投资管理详情
  getProjectDelivery: async (id: number) => {
    return await request.get({ url: `/engineering/projectDelivery/get?id=` + id })
  },

  // 新增工程投资管理
  createProjectDelivery: async (data: ProjectDeliveryVO) => {
    return await request.post({ url: `/engineering/projectDelivery/create`, data })
  },
  // 修改工程投资管理
  updateProjectDelivery: async (data: ProjectDeliveryVO) => {
    return await request.put({ url: `/engineering/projectDelivery/update`, data })
  },

  // 删除工程投资管理
  deleteProjectDelivery: async (id: number) => {
    return await request.delete({ url: `/engineering/projectDelivery/delete?id=` + id })
  },


  getEngineeringStatusList: async () => {
    return await request.get({ url: `/engineering/projectDelivery/getEngineeringStatusList`})
  },


  getFirstLevelMajorList: async () => {
    return await request.get({ url: `/engineering/projectDelivery/getFirstLevelMajorList`})
  },


  getConstructionCompanyList: async () => {
    return await request.get({ url: `/engineering/projectDelivery/getConstructionCompanyList`})
  },
